...
import 'package:lushitrap_flutter_client/assets.dart';
import 'package:lushitrap_flutter_client/data/song.dart';
import 'package:lushitrap_flutter_client/helpers/widget_utils.dart';
...
class SongPoster extends StatelessWidget {
      ...
      return new DecoratedBox(
        ...
        child: new Material(
          ...
          child: new IconButton(
            ...
            onPressed: () {
              //Todo ajouter apres un link pour aller sur lushitrap site
              //var url = song.viewArstist;
